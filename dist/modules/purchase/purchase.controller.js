...
class PurchaseController {
    constructor() {
        ...
        this.purchaseProduct = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const product = yield this.purchaseService.findProduct(parseInt(productId));
                if (!product) {
                ...
                balance -= totalPrice;
                const purchase = yield this.purchaseService.purchase({
                    userId: user.id,
                    productId: productId,
                    quantity,
                    totalPrice,
        ...
        //purchaseHistory
        this.purchaseHistory = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const id = parseInt(req.params.id);
                const purchaseHistory = yield this.purchaseService.purchaseHistory(id);
